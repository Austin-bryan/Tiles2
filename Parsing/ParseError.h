...
public:
	...
	void Throw(const TUniquePtr<LexerPosition>& position, char error, FString& expected) const;
	void Throw(const TUniquePtr<LexerPosition>& position, FString error, FString& expected) const;
protected:
	FString seed;
};
