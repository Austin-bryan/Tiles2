...
void ACreatorTile::DeselectAll()
{
    auto selectedTilesCache = selectedTiles;
    for (auto selectedTile : selectedTilesCache)
...
void ACreatorTile::Select(bool _isSelected, bool isDragSelecting)
{
